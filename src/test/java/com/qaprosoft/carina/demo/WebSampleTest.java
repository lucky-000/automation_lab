...
//	        homePage.inputText(searchingText);
	        List<SearchingItem> result = homePage.searchTextField(searchingText);
...
//	        for(SearchingItem n: result) {
//	        	System.out.println(n.readTitle());
//	        	Assert.assertTrue(StringUtils.containsIgnoreCase(n.readTitle(), searchingText), "Invalid search results!");
//	        }
